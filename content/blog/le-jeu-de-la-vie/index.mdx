...
> Live Demo : [Le Jeu de la Vie](https://game-of-life-bay.vercel.app/)
...
![clignotant](./blinker.gif 'clignotant')

##### Le pulsar (période 3)

![pulsar](./pulsar.gif 'pulsar')

##### La galaxie de kok (période 8)

![galaxie de kok](./kok.gif 'galaxie de kok')

##### Le pentadécathlon (période 15)

![pentadecathlon](./pentadecathlon.gif 'pentadecathlon')
...
![planneur](./planneur.gif 'planneur')
